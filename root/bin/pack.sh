...
echo "Copy apktool_2.12.1.jar and framework-res.apk ..."
cp /mnt/img/framework/framework-res.apk .
cp /root/etc/apktool_2.12.1.jar .
...
java -jar apktool_2.12.1.jar b --use-aapt1 app-src -o unsigned.apk
...
echo "Cleanup ..."
rm unsigned.apk framework-res.apk apktool_2.12.1.jar $APK_FILE.idsig || true
rm -R ./app-src || true
